...
public class Main_Counter {
    ...
    public static void main(String[] args) throws IOException {
        Main_Counter main = new Main_Counter(args[0], args[1], args[2]);
        main.initOutputDirectory();
        main.instru();
    }

    public Main_Counter(String projectDirectory, String srcDirectory, String outputDirectory) {
    ...
    public void instru() throws IOException {
        ...
        Processor processor = new CounterProcessor();
