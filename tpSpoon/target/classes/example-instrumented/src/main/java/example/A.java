...
**/
		vv.spoon.logger.LogWriter.out("A.main(String[] args)" + " 1",false);
...
**/
		vv.spoon.logger.LogWriter.out("A.mth1(int count)" + " 1",false);
...
**/
		vv.spoon.logger.LogWriter.out("error in A.mth1(int count)" + " 1",true);
            }
        }
